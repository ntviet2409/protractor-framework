export class ValidationsHelper {
    ...
    static getNonEmptyValidation(value: string) {
        return `${value} should not be empty`;
    }

    static getValueContainsValidation(actualValue: string, expectedValue: string) {
        return `${actualValue} should contains ${expectedValue}`;
    }
